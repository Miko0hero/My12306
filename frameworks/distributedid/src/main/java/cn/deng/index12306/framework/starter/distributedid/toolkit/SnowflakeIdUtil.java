package cn.deng.index12306.framework.starter.distributedid.toolkit;

import cn.deng.index12306.framework.starter.distributedid.core.snowflake.Snowflake;
import cn.deng.index12306.framework.starter.distributedid.core.snowflake.SnowflakeIdInfo;
import cn.deng.index12306.framework.starter.distributedid.handler.IdGeneratorManager;


/**
 * @author Deng
 * @date 2023/8/9
 * @description 分布式雪花ID生成器
 */
