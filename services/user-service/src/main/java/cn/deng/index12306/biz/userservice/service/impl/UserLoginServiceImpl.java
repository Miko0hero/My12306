...
import cn.deng.index12306.biz.userservice.common.constant.RedisKeyConstant;
import cn.deng.index12306.biz.userservice.common.enums.UserChainMarkEnum;
import cn.deng.index12306.biz.userservice.dao.entity.*;
import cn.deng.index12306.biz.userservice.dao.mapper.*;
import cn.deng.index12306.biz.userservice.dto.req.UserDeletionReqDTO;
import cn.deng.index12306.biz.userservice.dto.req.UserLoginReqDTO;
import cn.deng.index12306.biz.userservice.dto.req.UserRegisterReqDTO;
import cn.deng.index12306.biz.userservice.dto.resp.UserLoginRespDTO;
import cn.deng.index12306.biz.userservice.dto.resp.UserQueryRespDTO;
import cn.deng.index12306.biz.userservice.dto.resp.UserRegisterRespDTO;
...
import cn.deng.index12306.biz.userservice.toolkit.UserReuseUtil;
import cn.deng.index12306.framework.starter.cache.DistributedCache;
...
import cn.deng.index12306.framework.starter.convention.exception.ServiceException;
import cn.deng.index12306.framework.starter.designpattern.chain.AbstractChainContext;
import cn.deng.index12306.framework.starter.user.core.UserContext;
import cn.deng.index12306.framework.starter.user.core.UserInfoDTO;
import cn.deng.index12306.framework.starter.user.toolkit.JWTUtil;
...
import static cn.deng.index12306.biz.userservice.common.constant.RedisKeyConstant.LOCK_USER_REGISTER;
import static cn.deng.index12306.biz.userservice.common.constant.RedisKeyConstant.USER_DELETION;
import static cn.deng.index12306.biz.userservice.common.constant.RedisKeyConstant.USER_REGISTER_REUSE_SHARDING;
import static cn.deng.index12306.biz.userservice.common.enums.UserRegisterErrorCodeEnum.HAS_USERNAME_NOTNULL;
import static cn.deng.index12306.biz.userservice.common.enums.UserRegisterErrorCodeEnum.MAIL_REGISTERED;
import static cn.deng.index12306.biz.userservice.common.enums.UserRegisterErrorCodeEnum.PHONE_REGISTERED;
import static cn.deng.index12306.biz.userservice.common.enums.UserRegisterErrorCodeEnum.USER_REGISTER_FAIL;
import static cn.deng.index12306.biz.userservice.toolkit.UserReuseUtil.hashShardingIdx;
/**
 * @author Deng
 * @date 2023/8/15
 * @description
...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public Boolean hasUsername(String username) {
        if(userRegisterCachePenetrationBloomFilter.contains(username)){
            ...
            return Boolean.FALSE.equals(instance.opsForSet().isMember(RedisKeyConstant.USER_REGISTER_REUSE_SHARDING + UserReuseUtil.hashShardingIdx(username), username));
        }
        return false;
    }
    ...
    /**
     * 首先在注销表中增加一条记录，同时在邮箱和手机号的路由表中进行逻辑删除
     * 在可重新使用用户名表中增加记录，还有相关缓存操作
